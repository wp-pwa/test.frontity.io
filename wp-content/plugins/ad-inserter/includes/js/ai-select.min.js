...
"17"){ctrl_pressed=true;changeAction();if(current_element!=null&&current_element.prop("tagName")=="A")$(current_element).trigger("mouseover")}});$(document).keyup(function(){ctrl_pressed=false;changeAction();if(current_element!=null&&current_element.prop("tagName")=="A")$(current_element).trigger("mouseout")});$("body").css({"user-select":"none","margin-top":"140px"});$("body").prepend('<section id="ai-selector-data"> <table>                                                                         <tbody>                                                                         <tr>                                                                            <td class="data-name">ELEMENT</td>                                            <td class="data-value"><section id="ai-selector-element"></section></td>              <td><button type="button" id="ai-cancel-button" style="width: 90px;" title="Cancel element selection"> Cancel </button></td>                                                 </tr>                                                                         <tr>                                                                            <td>PATH</td>                                                                 <td><section id="ai-selector-path"></section></td>                                    <td><button type="button" id="ai-parent-button" style="width: 90px;" title="Select parent element"> Parent </button></td>                                                    </tr>                                                                         <tr>                                                                            <td>SELECTOR</td>                                                             <td style="width: 100%;"><input id="ai-selector" type="text" value="" maxlength="500" title="CSS selector" /></td>                                                             <td><button type="button" id="ai-use-button" style="width: 90px;" title="Use current selector"> Use </button>                                                                      <button type="button" id="ai-add-button" style="width: 90px; display: none;" title="Add current selector"> Add </button></td>                                            </tr>                                                                       </tbody>                                                                    </table>                                                                      </section>');
